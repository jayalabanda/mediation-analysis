...
iptw.direct.indirect <- function(data) {
  ...
  msm_m <- glm(M_smoking ~ A0_ace + L0_male + L0_parent_low_educ_lv, family = "binomial", data = data, weights = (gA / gA.L))
  ...
  return(list(iptw.EDN = iptw.EDN, iptw.EIN = iptw.EIN, sw = sw))
}
...
#############################################################################################################################################
#############################################################################################################################################
### 7) Redéfinition des paramètres et estimation par IPTW avec problème de positivité
#############################################################################################################################################
#############################################################################################################################################
